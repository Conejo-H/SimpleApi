...
function getTransactions(){
	return new Promise((resolve,reject) => {
		connection.query(`SELECT folio as idTransaccion, total as precio, fecha, tipopago, estacion  AS mostrador, sucursal as tienda, cajero as vendedor, estatus FROM detventas;`, (error, result) =>{
			if(error) return reject(error);
			resolve(result);
		})
	});
